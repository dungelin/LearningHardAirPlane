...
EnemyLayer::EnemyLayer( void )
{
	...
	enemy1Array=CCArray::create();
	enemy1Array->retain();
	enemy2Array =CCArray::create();
	enemy2Array->retain();
	enemy3Array=CCArray::create();
	enemy3Array->retain();
}
...
void EnemyLayer::addEnemy1( float dt )
{
	...
	this->enemy1Array->addObject(enemy1);
...
void EnemyLayer::enemy1MoveFinished( CCNode* pSender )
{
	...
	this->enemy1Array->removeObject(enmey1);
}
...
void EnemyLayer::removeEnemy1( CCNode* pTarget, void* data )
{
	...
	if (enemy1!=NULL)
	{
		enemy1Array->removeObject(enemy1);
...
{
	CCObject* obj;
	CCARRAY_FOREACH(enemy1Array,obj)
	{
...
void EnemyLayer::addEnemy2( float dt )
{
	...
	this->enemy2Array->addObject(enemy2);
...
void EnemyLayer::enemy2MoveFinished( CCNode* pSender )
{
	...
	this->enemy2Array->removeObject(enmey2);
}
...
void EnemyLayer::removeEnemy2( CCNode* pTarget, void* data )
{
	...
	if (enemy2!=NULL)
	{
		enemy2Array->removeObject(enemy2);
...
{
	CCObject* obj;
	CCARRAY_FOREACH(enemy2Array,obj)
	{
...
void EnemyLayer::addEnemy3( float dt )
{
	...
	this->enemy3Array->addObject(enemy3);
...
void EnemyLayer::enemy3MoveFinished( CCNode* pSender )
{
	...
	this->enemy3Array->removeObject(enmey3);
}
...
void EnemyLayer::removeEnemy3( CCNode* pTarget, void* data )
{
	...
	if (enemy3!=NULL)
	{
		...
		enemy3Array->removeObject(enemy3);
...
{
	CCObject* obj;
	CCARRAY_FOREACH(enemy3Array,obj)
	{
